	...
	private function add_scroll_to_top_button_section() {
		...
		$this->add_responsive_control( "{$name}_icon_size", [
			...
			'selectors'  => [
				...
				'.scroll-top-elementor-icon svg'                  => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}',
			],
			'condition'  => [
				'the7_scroll_to_top_button_enable' => 'enabled',
			],
		...
		$this->add_control( "{$name}_position", [
			'separator'            => 'before',
		...
		$this->add_control( "{$name}_h_offset_left", [
		...
		$this->add_control( "{$name}_h_offset_right", [
			'label'      => __( 'Horizontal Offset', 'the7mk2' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [ 'px', 'em', '%' ],
			'selectors'  => [
			...
			'condition'  => [
				"{$name}_position"                 => 'right',
				'the7_scroll_to_top_button_enable' => 'enabled',
			],
		] );
		$this->add_control( "{$name}_h_offset_center", [
			'label'      => __( 'Horizontal Offset', 'the7mk2' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [ 'px', 'em', '%' ],
			'selectors'  => [
				$selector => 'transform: translate3d(calc(50% + {{SIZE}}{{UNIT}}),0, 0px );',
			],
			'range'      => [
				'px' => [
					'min'  => - 1000,
			...
			'condition'  => [
				"{$name}_position"                 => 'center',
				'the7_scroll_to_top_button_enable' => 'enabled',
			],
		] );


		$this->add_control( "{$name}_v_offset", [
