...
class The7_Install {
	...
	public static function get_update_callbacks() {
		return [
			...
			'10.8.0'  => [
				[
					'callback'   => [ Migrations\v10_8_0\Arrows_Visibility_Migration::class, 'migrate' ],
					'args_array' => Migrations\v10_8_0\Arrows_Visibility_Migration::get_callback_args_array(),
				],
