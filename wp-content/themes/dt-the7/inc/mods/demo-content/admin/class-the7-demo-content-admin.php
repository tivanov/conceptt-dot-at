...
class The7_Demo_Content_Admin {
	...
	public function enqueue_scripts() {
		...
		$strings = [
			...
			'import_post_types_builder_data'     => esc_html__( 'Importing The7 Post Type Builder data.', 'the7mk2' ),
...
//		set_transient( 'the7_demo_admin_notice', compact( 'type', 'demo' ), 20 );
	...
	public function ajax_import_demo_content() {
		...
		if ( ! $demo ) {
			wp_send_json_error( [ 'error_msg' => '<p>' . __( 'Unable to recognise demo.', 'the7mk2' ) . '</p>' ] );
		}
